export const survey_07 = `<!-- @format -->
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <title>HR Research Survey Emailer 07</title>
    <style>
      body,
      table,
      td,
      ...
      /* Rainbow bar with solid fallback */
      .rainbow {
        height: 4px;
        line-height: 4px;
          ...
          >
            <tr>
              ...
              >
                ...
                >
                  <tr>
                    <td height="16" style="font-size: 0; line-height: 0">
                      &nbsp;
                    </td>
                  </tr>
                </table>

                <!-- CTA wrapper (left on desktop, center on mobile) -->
                <table
                  role="presentation"
                  width="100%"
                  cellpadding="0"
                ...
                style="
                  background: #e35c27;
                  border: 3px solid #d63900; /* bold outline */
                  border-bottom: 6px solid #d63900; /* bulletproof depth */
                  border-radius: 50px;
                  max-width: 220px;
                  padding: 14px 28px;
                  text-align: center;
                  box-shadow: 0px 8px 25px rgba(0, 0, 0, 0.4); /* progressive enhancement */
                "
              >
                <a
              ...
              >
                <img
                  src="https://public-cdn.hr.com/remoteimages/website-images/emailer-images/survey-mockup-aug-2025-v7-hero.jpg"
                  alt="Illustration with A, B, and checkmark icons"
                  width="200"
                  height="180"
                  style="
                    display: block;
