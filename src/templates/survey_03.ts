export const survey_03 = `<!-- @format -->
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <title>HR Research Survey Emailer 03</title>
    <style>
      body,
      table,
      td,
        ...
        <td style="padding: 0 20px">
          ...
          >
            <tr>
              ...
              >
                <img
                  src="https://public-cdn.hr.com/remoteimages/website-images/emailer-images/survey-mockup-aug-2025-v3-hero.jpg"
                  alt="Survey illustration on laptop"
                  width="240"
                  height="180"
                  style="
                    display: block;
