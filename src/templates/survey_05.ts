export const survey_05 = `<!-- @format -->
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <title>HR Research Survey Emailer 05</title>
    <style>
      body,
      table,
      td,
  ...
  <body>
    ...
    <table
      ...
      "
    >
      <!-- Header image (replaces top bar) -->
      <tr>
        <td style="padding: 0">
          <img
            src="https://public-cdn.hr.com/remoteimages/website-images/emailer-images/survey-mockup-aug-2025-v5-hero.jpg"
            width="600"
            style="
              display: block;
              border: 0;
          ...
          >
            <tr>
              ...
              >
                <img
                  src="https://public-cdn.hr.com/remoteimages/website-images/emailer-images/survey-mockup-aug-2025-v5-hero.jpg"
                  alt="Illustration of laptop with checkmark"
                  width="240"
                  height="180"
                  style="
                    display: block;
