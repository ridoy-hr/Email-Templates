export const survey_01 = `<!-- @format -->
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <title>HR Research Survey Emailer 01</title>
    <style>
      body,
      table,
      td,
        ...
        <td style="padding: 0 20px">
          ...
          >
            <tr>
              ...
              >
                <img
                  src="https://public-cdn.hr.com/remoteimages/website-images/emailer-images/survey-mockup-aug-2025-hero-01.jpg"
                  alt="Survey illustration: laptop with check mark"
                  width="180"
                  height="150"
                  style="
                    display: block;
