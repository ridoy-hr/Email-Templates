export const survey_04 = `<!-- @format -->
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <title>HR Research Survey Emailer 04</title>
    <style>
      body,
      table,
      td,
      ...
      /* Talent Acquisition bar */
      .ta-row {
        text-align: left;
      }
      .ta-badge {
        background: #cc4f1d; /* dark orange */
    ...
    >
      ...
      <tr>
        <td style="padding: 0 20px">
          ...
          >
            <!-- Orange bar row (flush top-left: no padding) -->
            <tr>
              <td class="ta-row" style="padding: 0">
                ...
                >
                  <tr>
                    ...
                    >
                      ...
                      >
                        <tr>
                          <td height="18" style="font-size: 0; line-height: 0">
                            &nbsp;
                          </td>
                        </tr>
                      </table>

                      <!-- CTA (embedded table button pattern) -->
                      <table
                        style="border-spacing: 0"
                        class="x_btn-table"
                        cellpadding="0"
                    ...
                    >
                      <img
                        src="https://public-cdn.hr.com/remoteimages/website-images/emailer-images/survey-mockup-aug-2025-v4-header.png"
                        alt="Illustration of laptop with survey elements"
                        width="240"
                        height="180"
                        style="
                          display: block;
