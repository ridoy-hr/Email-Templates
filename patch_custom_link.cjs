...
const customLinkCode = `const CustomBtnLink = () => {
  ...
  return (
    <div className="relative inline-block flex items-center">
      <button
        ...
        title="Link"
        className="p-1 hover:bg-gray-100 rounded text-gray-600 transition-colors mx-0.5 cursor-pointer"
      >
      ...
      {showInput && (
        <div className="absolute top-full left-0 mt-1 bg-white border border-gray-200 shadow-lg rounded-md p-2 flex items-center gap-2 z-50 min-w-[200px]">
          ...
          <button
            ...
            className="bg-blue-50 hover:bg-blue-100 text-blue-600 px-3 py-1.5 rounded text-xs font-medium transition-colors cursor-pointer"
          >
            Add
          </button>
        </div>
...
// Remove overflow-hidden from the container div
code = code.replace(
  'className="w-full bg-white rounded-md border border-gray-200 focus-within:ring-2 focus-within:ring-blue-500/20 focus-within:border-blue-500 overflow-hidden relative"',
  'className="w-full bg-white rounded-md border border-gray-200 focus-within:ring-2 focus-within:ring-blue-500/20 focus-within:border-blue-500 relative"'
);
